...
(function (global) {
  ...
  const DICT = {
    zh: {
      ...
      'consent.kicker': '研究參與',
      'consent.title': '登機前請先同意',
      'consent.copy': '甦醒航班是學術研究。登入後，你的航程、姓名、頭像與夜空留言會寫入主辦總表，供小隊看板與後續論文使用。論文發表前會去識別化。不同意請不要登入。',
      'consent.agree': '我已了解，並同意上述資料用於研究。',
    ...
    en: {
      ...
      'consent.title': 'Consent before boarding',
      'consent.copy': 'Sleep Airline is an academic study. After you sign in, your flights, name, photo and sky note are stored in the host log for the squad board and later papers. Identifiers are removed before publication. If you do not agree, please do not sign in.',
      'consent.agree': 'I understand and agree that this data may be used for research.',
