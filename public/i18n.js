...
(function (global) {
  ...
  const DICT = {
    zh: {
      ...
      'reminder.enabledOk': '降落提醒已啟用，醒來時會通知你回來降落。',
      'reminder.enabledLocal': '降落提醒已啟用（本機）。網頁開著時會準時提醒。',
    ...
    en: {
      ...
      'ready.takeoffAria': 'Ready for takeoff — choose a heading',
      'ready.go': 'Take off',
      ...
      'reminder.enabledOk': 'Landing reminder on — we’ll notify you when it’s time to land.',
      'reminder.enabledLocal': 'Landing reminder on (this device). Keep the tab open for timed alerts.',
      ...
      'board.waiting': 'Awaiting takeoff',
