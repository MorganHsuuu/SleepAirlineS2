...
export function parseFlightFromPage(page: Record<string, unknown>): Flight {
  ...
  return {
    ...
    directionSource: (readSelect(props, 'Direction Source') ?? 'system_auto') as Flight['directionSource'],
    ...
    captainBroadcastStyle: readSelect(props, 'Captain Broadcast Style') as Flight['captainBroadcastStyle'],
